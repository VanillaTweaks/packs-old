				...
				tag: NBT.stringify({
					...
					pages: [
						[
							...
							'\n    ',
							{ text: 'Move With Mouse', color: CLICKABLE_COLOR },
							{ text: '\n\nL/R ', color: HEADING_COLOR },
							...
							{ text: 'Move With Mouse', color: CLICKABLE_COLOR },
							'\n    ',
							{ text: 'Center on Block', color: CLICKABLE_COLOR },
							{ text: '\n\n Y   ', color: HEADING_COLOR },
							{ text: '-8', color: NEGATIVE_NUMBER_COLOR },
							' ',
							{ text: '-4', color: NEGATIVE_NUMBER_COLOR },
							' ',
							...
							{ text: 'Move With Mouse', color: CLICKABLE_COLOR },
							'\n      ',
							{ text: 'Snap to Block', color: CLICKABLE_COLOR },
							{ text: '\n\nB/F ', color: HEADING_COLOR },
							{ text: '-8', color: NEGATIVE_NUMBER_COLOR },
							' ',
							{ text: '-4', color: NEGATIVE_NUMBER_COLOR },
							' ',
